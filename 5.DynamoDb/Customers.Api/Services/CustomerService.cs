...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> UpdateAsync(Customer customer, DateTime requestedStarted)
    {
        var customerDto = customer.ToCustomerDto();
        ...
        return await _customerRepository.UpdateAsync(customerDto, requestedStarted);
    }
